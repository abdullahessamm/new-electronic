...
->group(__DIR__ . DIRECTORY_SEPARATOR . 'api' . DIRECTORY_SEPARATOR . 'auth.php');
...
->group(function () {
    ...
    ->group(__DIR__ . DIRECTORY_SEPARATOR . 'api' . DIRECTORY_SEPARATOR . 'users.php');
    ...
    ->group(__DIR__ . DIRECTORY_SEPARATOR . 'api' . DIRECTORY_SEPARATOR . 'sparePartsPermits.php');

    // employees
    Route::prefix('employees')
    ->controller(EmployeesController::class)
    ->group(__DIR__ . DIRECTORY_SEPARATOR . 'api' . DIRECTORY_SEPARATOR . 'employees.php');
