...
class User extends Authenticatable
{
    ...
    CONST ABILITIES = [
        ...
        'MonthlyReportingIncentives:index',
        'MonthlyReportingIncentives:create',
        'MonthlyReportingIncentives:update',
        'MonthlyReportingIncentives:delete',
    ];
    ...
    CONST ABILITY_MONTHLY_REPORTING_INCENTIVES_INDEX  =  'MonthlyReportingIncentives:index';
    CONST ABILITY_MONTHLY_REPORTING_INCENTIVES_CREATE =  'MonthlyReportingIncentives:create';
    CONST ABILITY_MONTHLY_REPORTING_INCENTIVES_UPDATE =  'MonthlyReportingIncentives:update';
    CONST ABILITY_MONTHLY_REPORTING_INCENTIVES_DELETE =  'MonthlyReportingIncentives:delete';
    /***** END ABILITIES *****/
